 ...
 * Use the {@link TimeWiseGraph#newInstance} factory method to
 * create an instance of this fragment.
 */
public class TimeWiseGraph extends Fragment {
    ...
    String TAG = TimeWiseGraph.class.getName();
     ...
     * @return A new instance of fragment TimeWiseGraph.
     */
    // TODO: Rename and change types and number of parameters
    public static TimeWiseGraph newInstance(String param1, String param2) {
        TimeWiseGraph fragment = new TimeWiseGraph();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        lineChart = lineChart.findViewById(R.id.linechart_time);
        scatterChart = scatterChart.findViewById(R.id.scatterChart_time);
        systolicVal = new ArrayList<>();
        xAxisValues = new ArrayList<>();
        getManualTasks();
        return inflater.inflate(R.layout.fragment_time_wise_graph, container, false);
...
//                plotScatterGraph(tasks);
                ...
                for (BloodPressureDB task : tasks) {
                    plotLineGraph(task.getSystolic(),task.getDystolic(),task.getHeartRate(),task.getTime());
                    plotScatterGraph(task.getSystolic(),task.getDystolic(),task.getHeartRate(),task.getTime());
                }
...
//    }
    ...
    public void plotLineGraph(int systolic, int diastolic, int rate, String time) {
        lineData = lineChart.getData();

//        for (BloodPressureDB list : task) {
            entryList1.add(new Entry(0,systolic));
            entryList2.add(new Entry(1,diastolic));
            entryList3.add(new Entry(2,rate));
...
//        }
    ...
    public void plotScatterGraph(int systolic, int diastolic, int rate, String time) {
